...
initialize_project <- function(path_to_project = NULL) {
  ...
  if(!dir.exists(paste0(path_to_project, "/output/wq/comparison_one_reserve_one_event/"))) { dir.create(paste0(path_to_project, "/output/wq/comparison_one_reserve_one_event/"))}
  ...
  if(!dir.exists(paste0(path_to_project, "/output/met/comparison_one_event_multi_reserve/"))) {dir.create(paste0(path_to_project, "/output/met/comparison_one_event_multi_reserve/"))}
  ...
  if(!dir.exists(paste0(path_to_project, "/output/met/comparison_one_reserve_one_event/"))) { dir.create(paste0(path_to_project, "/output/met/comparison_one_reserve_one_event/"))}
